...
/// @DnDVersion : 1
/// @DnDHash : 28532001
/// @DnDArgument : "code" "pistol = instance_create_layer(0,0,"Items",obj_pistol);$(13_10)pistol.ammo = 100;$(13_10)// ensure the gun is "disabled"$(13_10)pistol.currently_using = false;$(13_10)// add the gun to the player's inventory$(13_10)array_push(obj_player.inventory,pistol);$(13_10)"
